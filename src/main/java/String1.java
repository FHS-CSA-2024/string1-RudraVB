...
public class String1
{
    ...
    public String extraEnd(String str) {
        String repThree = str.substring(str.length()-2);
        return repThree + repThree + repThree;
    }
    ...
    public String withoutEnd(String str) {
        ...
        if (num >= 2){
            ...
            return "String needs to be atleast 2 letters";
        }
    }
    ...
    public String left2(String str) {
        if(str.length()>2){
            String rotate = str.substring(2);
            int rotateNum = rotate.length();
            int num = str.length();
            int backNum = str.length()-rotateNum;
            return rotate + str.substring(0,backNum);
        }
        else{
            return str;
        }
    ...
    public String conCat(String a, String b) {
        int aNum = a.length();
        if(b.length()>0 && a.substring(aNum-1).equals(b.substring(0,1))){
    ...
    public String withoutX(String str) {
        int num = str.length();
        if(str.substring(0,1).equals("x") && str.substring(num-1).equals("x")){
            return str.substring(1,num-1);
        }
        else if(str.substring(0,1).equals("x")){
            return str.substring(1);
        }
        else if(str.substring(num-1).equals("x")){
